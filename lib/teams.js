...
function finalizeOpenTeams(t) {
  ...
  // Selection order: checked-in teams first (if check-in is in use), then FIRST COME FIRST
  // SERVED - by when the team completed, not by rating. Rating decides seeding, never who is in.
